...
ActiveRecord::Schema[8.0].define(version: 2025_09_28_165646) do
  ...
  create_table "trend_entries", force: :cascade do |t|
    t.string "phrase"
    t.integer "count"
    t.string "window"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["phrase", "window", "window_start", "window_end"], name: "index_trend_entries_on_phrase_window_and_times", unique: true
    t.index ["window"], name: "index_trend_entries_on_window"
  end
